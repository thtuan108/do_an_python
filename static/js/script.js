        ...
        success: function(json) {
            ...
            if(json['redirect']) {
               ...
               $('.toast-container').html('')
                $('.toast-container').html(
                '<div data-delay="4000" class="toast fade"><div class="toast-header"><strong class="mr-auto"><i class="fa fa-globe"></i> Thông báo</strong><button type="button" class="ml-2 mb-1 close" data-dismiss="toast">&times;</button></div><div class="toast-body">' + json['message'] + '</div></div>'
                );
                $(".toast").toast('show', {
                    autohide: false,
                }); 
...
$('#message-modal').on('show.bs.modal', function (event) {
    ...
    var modal = $(this);
    modal.find('.card-form-subtitle').text('Bắt đầu trò chuyện với ' + username);
